...
class EnemyUI:
    ...
    def draw(self):
        ...
        screen.blit(name, (self.rect.x + 10, self.rect.y - 20))

        # health bar
        bar_width = self.WIDTH
        bar_height = 10

        hp_ratio = self.enemy.hp / self.enemy.max_hp   # temporärt max hp

        pygame.draw.rect(screen, (80,80,80),
                        (self.rect.x, self.rect.y - 10, bar_width, bar_height))

        pygame.draw.rect(screen, (200,50,50),
                         (self.rect.x, self.rect.y - 10, bar_width * hp_ratio, bar_height))
